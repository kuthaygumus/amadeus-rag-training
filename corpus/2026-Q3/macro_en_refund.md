# MACRO: REFUND-EN-018 — Refund Requests (Voluntary and Involuntary)

Document: CRM-MACRO-EN-018 | Revision: 7 | Effective: 2026-Q3 | Channel: Contact Centre (EN)
Related: Fare Rules CLASSIC / LITE / FLEX
...
**Step 1:** Verify coupon status. A no-show coupon follows the no-show rule: the change waiver is forfeited and the cancellation penalty doubles.
**Step 2:** LITE tickets are non-refundable; only unused taxes are returned.
**Step 3:** Raise the refund in the ticketing queue with the macro id.
