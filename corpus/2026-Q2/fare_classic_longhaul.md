...
RULE 1. Scope. This section governs voluntary changes and cancellations on CLASSIC fares in the
LONG-HAUL route band, including IST-JFK, IST-BKK and IST-GRU. Penalties are assessed per
passenger and per direction, in EUR. Long-haul penalties are NOT interchangeable with the
short-haul CLASSIC table; agents must select the sheet matching the route band actually flown.

RULE 2. Order of application. Collect the penalty first, then any residual fare difference, then
taxes and carrier-imposed charges. Only the transaction actually performed is charged.

| Booking class | Change penalty | Cancellation penalty | Refundable |
| --- | --- | --- | --- |
| O | EUR 110 | EUR 150 | Yes |
| T | EUR 125 | EUR 165 | Yes |
| Q | EUR 140 | EUR 180 | Yes |
| K | EUR 155 | EUR 195 | Yes |
| M | EUR 175 | EUR 220 | Yes |
...
A third piece is accepted at the published long-haul excess rate.
