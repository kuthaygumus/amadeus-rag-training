...
3.4 Where the connection wait exceeds **3 hours**, issue a meal voucher to the value of
    **EUR 10** per passenger. Infants without a seat are not entitled to a voucher.
3.5 Where the connection wait exceeds **8 hours**, arrange hotel accommodation with
    surface transfer. Hotel is arranged only through the contracted station provider.
3.6 Where the passenger holds a downstream segment on another carrier, refer the case to
    Hub Control before any reissue is attempted.
3.7 Record the disruption reference in the OCC daily log within 24 hours.

### 4. DUTY OF CARE
Duty of care is provided regardless of fare family. Nothing in this section creates an
entitlement to monetary compensation; compensation is assessed separately.
